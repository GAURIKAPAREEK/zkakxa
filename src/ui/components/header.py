...
def render_header(
    ...
    *,
    ...
    # Three intentional groups: brand | nav | actions
    # Equal side weights keep center nav visually centered (CSS maps to 1fr auto 1fr flex)
    brand_c, nav_c, actions_c = st.columns(
        [1, 1.15, 1],
        gap="small",
