...
[data-testid="stButton"] button[kind="primary"]:active p,
...
[data-testid="stDownloadButton"] button:focus p,
[data-testid="stDownloadButton"] button:active p {{ color: #fff !important; margin: 0 !important; }}
...
[data-testid="stButton"] button[kind="secondary"]:focus p,
[data-testid="stButton"] button[kind="secondary"]:active p,
[data-testid="stBaseButton-secondary"] p,
[data-testid="stBaseButton-secondary"]:hover p,
[data-testid="stBaseButton-secondary"]:focus p,
[data-testid="stBaseButton-secondary"]:active p {{ color: var(--ui-text) !important; margin: 0 !important; }}
...
/* Preserve white text for delete/confirm/cancel buttons inside popovers */
...
div[data-baseweb="popover"] .ui-profile-key,
...
div[data-baseweb="popover"] .ui-profile-val,
...
.ui-profile-body {{ flex: 1; min-width: 0; text-align: left; }}
.ui-profile-row,
div[data-baseweb="popover"] .ui-profile-row,
...
.block-container:has(.ui-hdr-anchor) [class*="st-key-ui_theme"],
.block-container:has(.ui-hdr-anchor) [class*="stKey-ui_theme"] {{
    display: flex !important;
    align-items: center !important;
    justify-content: center !important;
    height: 44px !important;
...
def _dashboard() -> str:
    r = RADIUS[14]
    return f"""
div[data-testid="stHorizontalBlock"]:has(.ui-hero),
div[data-testid="stHorizontalBlock"]:has(.ui-panel-anchor) {{
    display: flex !important;
    align-items: stretch !important;
    gap: 20px !important;
}}
div[data-testid="stHorizontalBlock"]:has(.ui-hero) > div[data-testid="column"],
div[data-testid="stHorizontalBlock"]:has(.ui-hero) > div[data-testid="stColumn"],
div[data-testid="stHorizontalBlock"]:has(.ui-panel-anchor) > div[data-testid="column"],
div[data-testid="stHorizontalBlock"]:has(.ui-panel-anchor) > div[data-testid="stColumn"] {{
    display: flex !important;
...
div[data-testid="stHorizontalBlock"]:has(.ui-hero) [data-testid="stVerticalBlock"],
div[data-testid="stHorizontalBlock"]:has(.ui-hero) [data-testid="stElementContainer"],
div[data-testid="stHorizontalBlock"]:has(.ui-hero) [data-testid="element-container"],
div[data-testid="stHorizontalBlock"]:has(.ui-hero) [data-testid="stMarkdownContainer"],
div[data-testid="stHorizontalBlock"]:has(.ui-panel-anchor) [data-testid="stVerticalBlock"],
div[data-testid="stHorizontalBlock"]:has(.ui-panel-anchor) [data-testid="stElementContainer"],
div[data-testid="stHorizontalBlock"]:has(.ui-panel-anchor) [data-testid="element-container"],
div[data-testid="stHorizontalBlock"]:has(.ui-panel-anchor) [data-testid="stMarkdownContainer"] {{
    height: 100% !important;
    margin: 0 !important;
}}
.ui-hero {{
    ...
    background: var(--ui-glass) !important; backdrop-filter: blur(16px) !important;
    border: 1px solid var(--ui-border) !important; border-radius: {RADIUS[18]}px !important;
    box-shadow: var(--ui-shadow-sm) !important;
...
@media (max-width: 768px) {{
    .ui-hero {{ gap: 12px; padding: 16px 18px !important; }}
...
.ui-hero-copy {{ position: relative; z-index: 1; max-width: 100%; min-width: 0; }}
.ui-hero-status {{ position: relative; z-index: 1; display: flex; align-items: center; justify-content: flex-start; margin-top: auto !important; }}
.ui-hero::before {{
    content: "" !important; position: absolute; inset: 0;
    background: radial-gradient(ellipse 42% 120% at 100% 0%, var(--ui-accent-soft), transparent 70%) !important;
    pointer-events: none;
    display: block !important;
}}
.ui-hero-kicker {{
...
.ui-hero-title {{
    font-family: 'Outfit', system-ui, sans-serif;
    font-size: clamp(28px, 2.2vw, 36px); font-weight: 800; letter-spacing: -0.03em;
    margin: 0; color: var(--ui-text) !important; line-height: 1.15;
}}
.ui-hero-lede {{
    margin: 8px 0 0; color: var(--ui-text-2) !important;
...
[data-testid="stColumn"]:has(.ui-panel-anchor) > div[data-testid="stVerticalBlock"],
div[data-testid="column"]:has(.ui-panel-anchor) [data-testid="stVerticalBlock"],
div[data-testid="stColumn"]:has(.ui-panel-anchor) [data-testid="stVerticalBlock"] {{
    background: var(--ui-glass) !important;
    backdrop-filter: blur(16px) !important;
    border: 1px solid var(--ui-border) !important;
    border-radius: {RADIUS[18]}px !important;
...
div[data-testid="stFileUploaderDropzone"] {{
    ...
    border: 1.5px dashed var(--ui-border-strong) !important;
    border-radius: 14px !important;
    box-shadow: none !important;
    ...
    gap: 8px !important;
    box-sizing: border-box !important;
    transition: border-color 240ms {EASING}, background 240ms {EASING} !important;
}}
...
[data-testid="stFileUploaderDropzoneInstructions"] svg:not(button svg),
[data-testid="stFileUploaderDropzoneInstructions"] [data-testid="stIconMaterial"]:not(button *),
[data-testid="stFileUploaderDropzoneInstructions"] [data-testid="stIconCustom"]:not(button *),
[data-testid="stFileUploaderDropzoneInstructions"] i:not(button *) {{
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
    width: 0 !important;
...
[data-testid="column"]:has(.ui-panel-anchor) .ui-section,
[data-testid="stColumn"]:has(.ui-panel-anchor) .ui-section,
div[data-testid="column"] .ui-section,
div[data-testid="stColumn"] .ui-section,
.ui-panel-anchor ~ .ui-section,
.ui-panel-anchor + .ui-section {{
...
def _tables() -> str:
    r = RADIUS[14]
    up_icon = (
        "%3Csvg xmlns='http://www.w3.org/2000/svg' width='34' height='34' viewBox='0 0 34 34' fill='none' "
        "stroke='%2338BDF8' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3E"
        "%3Cpath d='M7 21v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4'/%3E"
        "%3Cpath d='M17 21V7'/%3E%3Cpath d='M11 13l6-6 6 6'/%3E%3C/svg%3E"
    )
    return f"""
...
[data-testid="stPlotlyChart"] {{
    ...
    border-radius: {r}px; padding: {SP[12]}px {SP[16]}px; box-shadow: var(--ui-shadow-sm);
...
@media (max-width: 900px) {
    ...
    /* Plotly trend charts stacking & responsive sizing on mobile/tablet */
    ...
    div[data-testid="stHorizontalBlock"]:has([data-testid="stPlotlyChart"]) > [data-testid="column"],
    div[data-testid="stHorizontalBlock"]:has([data-testid="stPlotlyChart"]) > [data-testid="stColumn"] {
        width: 100% !important;
        max-width: 100% !important;
        flex: 1 1 100% !important;
        min-width: 100% !important;
